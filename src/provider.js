...
async function accessStats() {
    ...
    await request("http://clashofclansforecaster.com/PAGEHITS.json", {});

    // This returns everything the site offers, with the translated 
    // messages and everything, and the trend which (-1 when going down, 1 when going up)
